...
WebFont.load({
  ...
  active: function active() {
    PIXI.loader.add('bg', 'assets/bg.png').add('thlen', 'assets/thlen.png').add('blocks', 'assets/spritesheets/blocks.json').add('player', 'assets/spritesheets/player.json').add('displacement', 'assets/filters/displacement.png').add('noise', 'assets/filters/noise_grayscale.png').add('particle', 'assets/filters/particle.png').add('music', 'assets/sounds/music.mp3').load(function (loader, resources) {
      var game = new Game();
